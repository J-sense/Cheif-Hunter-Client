    ...
    return (
        <div className="my-container">
            ...
            <div className="lg:mt-20 mt-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:m-36 gap-5">
                    <div className="card w-full bg-white shadow-lg transform transition duration-700 hover:scale-105 rounded-lg overflow-hidden border-2 border-gray-300 hover:shadow-xl  p-6 ease-in-out relative ">
