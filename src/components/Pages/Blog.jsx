...
const Blog = () => {
    ...
    return (
        <div className=' bg-slate-300'>
            ...
            <div className='mb-5 px-6 md:px-12 max-w-2xl mx-auto lg:px-16 block md:flex lg:flex md:justify-between pt-12 pb-12'>
                <h2 className='text-2xl font-bold '>Assignment Question :</h2>
                <ReactToPdf targetRef={ref} filename="questions.pdf">
                    {({ toPdf }) =>
                        <button onClick={toPdf} className="mt-3 md:mt-0 bg-gradient-to-r bg-orange-500 rounded-md px-4 py-2 text-white font-semibold">
                            Download PDF
                        </button>}
                </ReactToPdf>
            </div>
